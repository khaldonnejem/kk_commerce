...
<div class="row">
    ...
    <div class="mb-3">
       ...
       <textarea name="content_en" placeholder="English Name" class="myeditor">{{ $product->content_en }}</textarea>
    </div>

    <div class="mb-3">
        <label>Arabic Content</label>
        <textarea name="content_ar" placeholder="Arabic Name" class="myeditor">{{ $product->content_ar }}</textarea>
    </div>
