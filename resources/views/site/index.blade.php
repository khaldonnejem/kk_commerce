					...
					<li class="dropdown full-width dropdown-slide">
						...
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<a href="shop.html">
										<img class="img-responsive" src="{{ asset('siteassets/images/shop/header-img.jpg') }}" alt="menu image" />
									</a>
								</div>
							</div><!-- / .row -->
						</div><!-- / .dropdown-menu -->
...
<div class="hero-slider">
  <div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('siteassets/images/slider/slider-1.jpg') }});">
    <div class="container">
      <div class="row">
  ...
  <div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('siteassets/images/slider/slider-3.jpg') }});">
    <div class="container">
      <div class="row">
  ...
  <div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('siteassets/images/slider/slider-2.jpg') }});">
    <div class="container">
      <div class="row">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-1.jpg') }}" alt="product-img" />
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-2.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-3.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-4.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-5.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-6.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<span class="bage">Sale</span>
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-7.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-8.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/product-9.jpg') }}" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span  data-toggle="modal" data-target="#product-modal">
			        	...
			        	<div class="row">
			        		<div class="col-md-8 col-sm-6 col-xs-12">
			        			<div class="modal-image">
				        			<img class="img-responsive" src="{{ asset('siteassets/images/shop/products/modal-product.jpg') }}" alt="product-img" />
			        			</div>
			        		</div>
